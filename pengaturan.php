...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
            ...
            <li class="active"><a href="pengaturan.php"><em class="fa fa-cog">&nbsp;</em> Pengaturan</a></li>
                ...
                <div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="table-responsive">       
                            <article class="table">  
                                <iframe height="345px" width="100%" src="pengaturan/index.php" name="iframe_a" style="border:1px;"></iframe>
                            </article>
                        </div>
					</div>
                </div>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="table-responsive">       
                            <article class="table">  
                                <iframe height="345px" width="100%" src="pengaturan/add.php" name="iframe_a" style="border:1px;"></iframe>
                            </article>
                        </div>
					</div>
				</div>
