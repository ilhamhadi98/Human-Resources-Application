		...
		<ul class="nav menu">
			...
			<li class="parent"><a data-toggle="collapse" href="#sub-item-1"><em class="fa fa-user">&nbsp;</em> Karyawan <span data-toggle="collapse" href="#sub-item-1" class="icon pull-right"></span>
                ...
                <ul class="children collapse" id="sub-item-1">
					...
					<li><a class="active" href="cuti.php">
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Daftar Cuti</div>
					   <div class="panel-body">
						<div class="table-responsive">          
                            <div class="table-responsive">       
                                <article class="table">  
                                    <iframe height="700px" width="100%" src="cuti/index.php" name="iframe_a" style="border:0px;"></iframe>
                                </article>
                            </div>
					       </div>
				        </div><!-- /.panel-->
