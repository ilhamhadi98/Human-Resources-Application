...
{	
	...
	$nik=$_POST['nik'];
	$tanggal_transaksi=$_POST['tangggal_transaksi'];
	$total=$_POST['total'];
    $status=$_POST['status'];
		
	// update user data
	$result = mysqli_query($mysqli, "UPDATE penggajian SET nik='$nik',tanggal_transaksi='$tanggal_transaksi',total='$total',status='$status' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM penggajian WHERE id=$id");
 
while($user_data = mysqli_fetch_array($result))
{
	$nik = $user_data['nik'];
	$tanggal_transaksi = $user_data['tanggal_transaksi'];
