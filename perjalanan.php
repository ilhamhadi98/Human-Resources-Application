...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="perjalanan.php"><em class="fa fa-plane">&nbsp;</em> Perjalanan</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Daftar Perjalanan</h1>
			</div>
		</div><!--/.row-->
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="table-responsive">       
                            <article class="table">  
                                <iframe height="300px" width="100%" src="perjalanan/add.php" name="iframe_a" style="border:1px;"></iframe>
                            </article>
                        </div>
					</div>
				</div>
        ...
        <div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">List Perjalanan</div>
					   <div class="panel-body">
						  <div class="table-responsive">       
                            <article class="table">  
                                <iframe height="400px" width="100%" src="perjalanan/index.php" name="iframe_a" style="border:0px;"></iframe>
                            </article>
                        </div>
                    </div>
				</div><!-- /.panel-->
