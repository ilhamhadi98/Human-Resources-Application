...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
            ...
            <li class="active"><a href="penggajian.php"><em class="fa fa-euro">&nbsp;</em> Penggajian</a></li>
					...
					<div class="panel-heading">Daftar Penggajian</div>
					   <div class="panel-body">
						  <div class="table-responsive">       
                            <article class="table">  
                                <iframe height="400px" width="100%" src="penggajian/index.php" name="iframe_a" style="border:1px;"></iframe>
                            </article>
                        </div>
                    </div>
				</div><!-- /.panel-->
